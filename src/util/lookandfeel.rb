		...
		class Lookandfeel < SBSM::Lookandfeel
			...
			DICTIONARIES = {
				'en'	=>	{
					...
					:hungarian								=>	'Hungarian',
					:hunting									=>	'Hunting',
					:image_chooser_link_images_title	=>	'These Images already belong to the link.',
					:image_chooser_title			=>	'... or choose one or more images from below.',
					:image_chooser_uploadtitle	=>	'You can upload images...',
