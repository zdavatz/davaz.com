...
module DaVaz::View
  module Works
    ...
    class JavaApplet < HtmlGrid::Component
      def init
        super
        image = DaVaz::Util::ImageHelper.image_url(@model)
        @value = <<~EOS.gsub(/\n/, '')
          <applet name="ptviewer" valign=bottom border=0 hspace=0 vspace=0
           archive="/resources/java/ptviewer.jar"
           code=ptviewer.class
           ...
           <param name=shotspot0
           value="x310 y186 a324 b200 u'ptviewer:startAutoPan(0.5,0,1)'">
           <param name=shotspot1
           value="x324 y186 a338 b200 u'ptviewer:stopAutoPan()'">
           <param name=shotspot2
           value="x338 y186 a352 b200 u'ptviewer:startAutoPan(0,0,0.97)'">
           <param name=shotspot3
           value="x352 y186 a366 b200 u'ptviewer:startAutoPan(0,0,1.03)'">
           <param name=shotspot4
           value="x366 y186 a380 b200 u'ptviewer:gotoView(0,0,80)'">
           <param name=pano0
           value="{file=#{image}}
           {pan=-45}
           {tilt=-50}
    ...
    class ThumbImages < HtmlGrid::SpanList
      ...
      def image(model)
        ...
        url = @lookandfeel.event_url(:works, :ajax_multiples, [
